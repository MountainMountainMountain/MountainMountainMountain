...
CREATE TABLE IF NOT EXISTS `finalMountainPJT`.`User` (
  ...
  PRIMARY KEY (`serial`),
  UNIQUE INDEX `id_UNIQUE` (`serial` ASC) ,
...
CREATE TABLE IF NOT EXISTS `finalMountainPJT`.`ChatManager` (
  ...
  INDEX `fk_mountain_serial_idx` (`mountain_serial` ASC) ,
...
CREATE TABLE IF NOT EXISTS `finalMountainPJT`.`Chat` (
  ...
  PRIMARY KEY (`serial`),
  UNIQUE INDEX `serial_UNIQUE` (`serial` ASC) ,
  INDEX `fk_manager_serial_idx` (`chatmanager_serial` ASC) ,
  INDEX `fk_user_serial_idx` (`user_serial` ASC) ,
...
-- -----------------------------------------------------
-- Table `finalMountainPJT`.`Review`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `finalMountainPJT`.`Review` (
  `serial` INT NOT NULL  AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `finalMountainPJT`.`ReviewFile`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `finalMountainPJT`.`ReviewFile` (
  `serial` INT NOT NULL  AUTO_INCREMENT,
  `user_serial` INT NOT NULL,
  `review_serial` INT NOT NULL,
  ...
  UNIQUE INDEX `serial_UNIQUE` (`serial` ASC) ,
  INDEX `fk_user_serial_idx` (`user_serial` ASC) ,
  INDEX `fk_review_serial_idx` (`review_serial` ASC) ,
  CONSTRAINT `fk_user_serial`
    FOREIGN KEY (`user_serial`)
    REFERENCES `finalMountainPJT`.`User` (`serial`)
    ON DELETE NO ACTION
  ...
  CONSTRAINT `fk_review_serial`
    FOREIGN KEY (`review_serial`)
    REFERENCES `finalMountainPJT`.`Review` (`serial`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `finalMountainPJT`.`Follow` (
  ...
  PRIMARY KEY (`serial`),
  UNIQUE INDEX `serial_UNIQUE` (`serial` ASC) ,
  INDEX `fk_from_serial_idx` (`from_serial` ASC) ,
  INDEX `fk_to_serial_idx` (`to_serial` ASC) ,
